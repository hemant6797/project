...
export default function PlayGame({ setPlay, islogin, user, setUser }) {
  ...
  return (
    ...
    >
      <Card
        style={{
          backgroundImage: "linear-gradient(315deg, #a55c1b 0%, #000000 80%)",
        ...
        title={
          <div className="d-block">
            <h2 className="">
              <span
                className=" p-1 px-3 ant-card-hoverable  rounded border  rounded-pill  text-white"
                style={{
                  backgroundImage: "linear-gradient(315deg, #a55c1b 0%, #000000 80%)",
